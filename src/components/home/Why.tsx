        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          {WHY_ITEMS.map((item, index) => (
            ...
            >
              ...
              <p className="text-[14px] leading-[1.65] text-muted">{item.description}</p>
            </article>
          ))}
        </div>
      </div>
