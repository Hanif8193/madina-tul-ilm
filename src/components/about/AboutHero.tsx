...
export default function AboutHero() {
  ...
  return (
    <section className="relative overflow-hidden bg-green pb-24 pt-16" aria-labelledby="about-hero-heading">
      <span
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-[100px] -right-[100px] h-[400px] w-[400px] rounded-full border border-gold/[0.06]"
      />
      <span
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-[60px] -right-[60px] h-[280px] w-[280px] rounded-full border border-gold/[0.04]"
      />
